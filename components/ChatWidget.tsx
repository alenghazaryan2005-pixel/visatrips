...
const FAQ_ENTRIES = [
  ...
  { keywords: ['cost', 'price', 'how much', 'fee', 'pay'], answer: 'Our eVisa prices start at $25 for a 30-day Tourist visa. Business visas are $80. Government fees are included — no hidden charges.' },
  ...
  { keywords: ['business', 'business visa'], answer: 'The Business eVisa costs $80, valid for 1 year with multiple entries. Maximum stay is 180 days per visit.' },
  { keywords: ['medical', 'medical visa', 'treatment'], answer: 'The Medical eVisa costs $25, valid for 60 days with triple entry. You\'ll need a letter from the hospital in India.' },
  ...
  { keywords: ['multiple', 'entry', 'entries'], answer: 'The 30-day Tourist visa allows double entry. The 1-year and 5-year Tourist visas, as well as Business visas, allow multiple entries.' },

...
export default function Home() {
  return (
    // `legacy-palette` keeps the backup of the old homepage design
    // rendering with its original marketing periwinkle
    // (var(--blue) = #6C8AFF). The rest of the site — including
    // the new home at "/" — uses the new navy + light-blue palette
    // from :root.
